/*
  ...
  - Added the required column `updatedAt` to the `ShopSettings` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_ShopSettings" ("BannerEnable", "ChartIconId", "ShopId", "SizePlacement", "borderStyle", "customCss", "focusColor", "headerColor", "headerFontColor", "id", "sizeGuideTitle", "zebraLinesColor") SELECT "BannerEnable", "ChartIconId", "ShopId", "SizePlacement", "borderStyle", "customCss", "focusColor", "headerColor", "headerFontColor", "id", "sizeGuideTitle", "zebraLinesColor" FROM "ShopSettings";
