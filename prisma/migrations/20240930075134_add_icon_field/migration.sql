...
INSERT INTO "new_PredefinedSizeChart" ("allow_converter", "allow_converter_in", "content", "createdAt", "id", "image", "name", "rounding_mode", "rounding_numOfDecimals", "rounding_roundTo", "sizeCategoryId", "status", "updatedAt", "user_chart_data") SELECT "allow_converter", "allow_converter_in", "content", "createdAt", "id", "image", "name", "rounding_mode", "rounding_numOfDecimals", "rounding_roundTo", "sizeCategoryId", "status", "updatedAt", "user_chart_data" FROM "PredefinedSizeChart";
